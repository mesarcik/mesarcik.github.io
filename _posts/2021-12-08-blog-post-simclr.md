...
**3.3 SimCLR Loss**
The next part of the implementation is the SimCLR loss. Here we implement the loss function in the most readable, but probably the least efficient way. First, the softmax-based loss is defined below: 
...
We then iterate over each batch, calculate the similarities and update the weights of the model defined above. 
